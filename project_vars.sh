...
# Callback URL
################################################
export CALLBACK_URL="" # e.g., "http://localhost:5000" or AWS url

################################################
# the token that is used for NGROK (optional | alternative to CALLBACK_URL)
################################################
export NGROK_AUTHTOKEN=""
export NGROK_SECRET=""
export NGROK_PORT="80" # default port, required for CALLBACK_URL or ngrok
...
################################################
# running docker on k8s variables (requested machine configuration)
################################################
export NGPU=1
export GPU_TYPE="A5000" # "2080Ti" "A5000"
export TOTAL_CPU=16
export TOTAL_MEM=128
export MODE="run"
